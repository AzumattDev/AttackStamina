...
namespace AttackStamina
{
    ...
    public static class VerifyClient
    {
        private static bool Prefix(ZRpc rpc, ZPackage pkg, ref ZNet __instance)
        {
            ...
            AttackStaminaPlugin.AttackStaminaLogger.LogWarning(
        ...
        {
            ZRoutedRpc.instance.InvokeRoutedRPC(ZRoutedRpc.instance.GetServerPeerID(), $"{AttackStaminaPlugin.ModName}RequestAdminSync",
                new ZPackage());
        }
    }
    ...
    public static class RemoveDisconnectedPeerFromVerified
    {
        private static void Prefix(ZNetPeer peer, ref ZNet __instance)
        {
            ...
            AttackStaminaPlugin.AttackStaminaLogger.LogInfo(
    ...
    public static class RpcHandlers
    {
        ...
        public static void RPC_AttackStamina_Version(ZRpc rpc, ZPackage pkg)
        {
            ...
            AttackStaminaPlugin.AttackStaminaLogger.LogInfo("Version check, local: " +
                                                            AttackStaminaPlugin.ModVersion +
                                                            ",  remote: " + version);
            if (hash != hashForAssembly || version != AttackStaminaPlugin.ModVersion)
            {
                AttackStaminaPlugin.ConnectionError = $"{AttackStaminaPlugin.ModName} Installed: {AttackStaminaPlugin.ModVersion} {hashForAssembly}\n Needed: {version} {hash}";
